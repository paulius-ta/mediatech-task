    ...
    <>
      <header className={'header'}>
        <div className={'header__content'}>
          <img src={'icons/ic_cb-logo.svg'} className={'logo'} alt="Logo" />
        </div>
      </header>
      ...
      <main className={'page-content'}>
        <div className={'page-content__body'}>
          <p className={'disclaimer'}>
            Our readers help us create quality content. If you purchase via links on our site, we
            may receive affiliate commissions. <a href={'/'}>Learn more</a>
          </p>
          ...
          <section className={'what-it-is-section'}>
            <figure className={'what-it-is-section__figure'}>
              <img src={'icons/ic_password-generator.svg'} alt="Password generator" />
            </figure>
          ...
          <section className={'how-it-works-section'}>
            <figure className={'how-it-works-section__figure'}>
              <img src={'icons/ic_password-strength.svg'} alt="Password strength" />
            </figure>
            <div className={'how-it-works-section__body'}>
              ...
              <p>
                ...
                numeric digits, and 32 special symbols. The result is a unique 12-character
                sequence. This number of characters makes your future password downright
                unbreakable, taking 1.4 billion years for a brute-force attack to crack it.
              </p>
              <p>
